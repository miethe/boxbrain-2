...
# Ordered most-specific-first so the loop matches the most precise prefix.
LAYER_MAPPING = {
    # Routers - HTTP entry points (SkillMeat-actual paths)
    'skillmeat/api/routers/': 'router',

    # Services - Business logic (SkillMeat-actual paths)
    'skillmeat/core/services/': 'service',

    # Repositories - Data access (SkillMeat-actual paths)
    'skillmeat/cache/': 'repository',

    # Schemas - DTOs and serialization (SkillMeat-actual paths)
    'skillmeat/api/schemas/': 'schema',
    'skillmeat/core/interfaces/': 'schema',

    # Core - Configuration and utilities (SkillMeat-actual paths)
    'skillmeat/api/': 'core',
    'skillmeat/core/': 'core',
    'skillmeat/cli/': 'core',
    'skillmeat/storage/': 'core',
    'skillmeat/sources/': 'core',
    'skillmeat/marketplace/': 'core',
    'skillmeat/observability/': 'observability',

    # Auth
    'auth/': 'auth',

    # Middleware - Request processing
    'skillmeat/api/middleware/': 'middleware',
