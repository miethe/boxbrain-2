...
# Ordered most-specific-first within each layer so that startswith() matches
# the most precise prefix before falling through to the broader 'core' bucket.
LAYER_PATH_MAPPING = {
    'router': ['skillmeat/api/routers/'],
    'service': ['skillmeat/core/services/'],
    'repository': ['skillmeat/cache/'],
    'schema': ['skillmeat/api/schemas/', 'skillmeat/core/interfaces/'],
    'core': [
        'skillmeat/api/middleware/', 'skillmeat/api/',
        'skillmeat/core/', 'skillmeat/cli/',
        'skillmeat/storage/', 'skillmeat/sources/',
        'skillmeat/marketplace/', 'skillmeat/observability/',
        'auth/',
    ]
}
