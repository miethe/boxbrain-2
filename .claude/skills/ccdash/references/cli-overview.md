...
This is query scoping only. It does not create records in the server `projects.json` registry and does not rebind a running `worker-watch` container. For container project preparation and watcher env overlays, use `references/container-project-onboarding.md`.
...
- Container project onboarding and watcher binding: `container-project-onboarding.md`
