...
| Closed worktree session lost committed work (branch/worktree gone) | Recover dangling commits — see `./techniques/recovering-orphaned-worktree-commits.md` |
...
| `./techniques/recovering-orphaned-worktree-commits.md` | Recover committed work orphaned by a closed worktree session (git fsck dangling commits + safe squash-merge) |
...
- Orphaned worktree commits: `./techniques/recovering-orphaned-worktree-commits.md`
