...
**Canonical docs**: `CLAUDE.md § "Memory System"` and `skillmeat/api/CLAUDE.md`. This file covers agent-specific workflows and the API fallback procedure. Command syntax is authoritative in `.claude/rules/memory.md`.
